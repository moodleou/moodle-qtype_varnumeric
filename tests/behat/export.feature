...
Feature: Test exporting Variable numeric questions
  As a teacher
  In order to be able to reuse my Variable numeric questions
  ...
  Scenario: Export a Variable numeric question
